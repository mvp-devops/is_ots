...
const MonitoringPageView = () => {
  const { currentItem, currentItemFolderPath } = useTypedSelector((state) => state.positionTree);
  return (
    <div className="p-2">
      {currentItem &&
          ...
          <Image.PreviewGroup>
            ...
            >
              ...
              >
                <Image
                  width={800}
                  src={setFilePath(`${currentItemFolderPath}/Monitoring/001.png`)}
                  alt=""
                />
              </Text>
              <Text
              ...
              >
                <Image width={800} src={setFilePath(`${currentItemFolderPath}/Monitoring/002.png`)} />
              </Text>
            </Space>
            <Space
              direction="horizontal"
            ...
            >
              ...
              Информация будет подтягиваться из таблиц БД"
              >
                <Image width={800} src={setFilePath(`${currentItemFolderPath}/Monitoring/003.png`)} />
              </Text>

              <Text title="Мнемосхема объекта с описанием легенды">
                <Image width={800} src={setFilePath(`${currentItemFolderPath}/Monitoring/004.png`)} />
              </Text>
            </Space>
          </Image.PreviewGroup>
        )}
