...
export const cableEntry = [
  {
    id: 1,
    title: "М20х1,5 под бронированный кабель (проволочная броня) диаметром 7…18 мм",
    value: "М20х1,5 под бронированный кабель (проволочная броня) диаметром 7…18 мм"
  },
  {
    id: 2,
    title: "М20х1,5 под бронированный кабель (ленточная броня) диаметром 7…18 мм",
    value: "М20х1,5 под бронированный кабель (ленточная броня) диаметром 7…18 мм"
  },
  {
    id: 3,
    title: "М20х1,5 под небронированный кабель диаметром 7…18 мм",
    value: "М20х1,5 под небронированный кабель диаметром 7…18 мм"
  },
  {
    id: 4,
...
/* Термообогрев */
export const heating = ["Не предусмотрено", "Термочехол", "Термобокс"]
...
export const thermCase = [
  ...
  },
  {
    ...
    value: "Для датчика с клапанным блоком, без электрообогрева"
  }
]
/* Термобокс */
...
export const mountingBracket = [
  {
    id: 1,
    title: "Г-образный, труба диаметром до 50 мм",
    value: "Г-образный для крепления датчика к трубе диаметром до 50 мм"
  },
  {
    id: 2,
    title: "Г-образный, труба диаметром до 100 мм",
    value: "Г-образный для крепления датчика к трубе диаметром до 100 мм"
  },
  {
    id: 3,
