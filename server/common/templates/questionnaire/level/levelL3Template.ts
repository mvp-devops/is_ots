export const levelL3Template = (data: any) => {
  const {accuracy, safety, connectionType, connection, calibrationStamp, verification, mpi, cableEntry, reserveCableEntryStub, heating, thermCase, thermBox} = data;
