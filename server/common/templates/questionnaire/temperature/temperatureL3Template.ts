export const temperatureL3Template = (data: any) => {
    const {calibrationStamp, mpi, verification, connectionType, connection,  cableEntry, reserveCableEntryStub, accuracy, relativeAccuracy, heating, thermCase, thermBox} = data;
    return `
            <style>
              table.l3 {
            ...
            <table class="l3">
              ...
              <tbody>
                <tr class="l3-row1">
                  ...
                  <td class="l3-td" colspan="2">${connectionType}</td>
                </tr>
                <tr class="l3-row2">
                  <td class="l3-td">Соединение с тех. процессом</td>
                  <td class="l3-td" colspan="2">${connection}</td>
                </tr>
                ...
                <tr class="l3-row2">
                  <td class="l3-td">
                    Предел относительной погрешности измерения нормирующего
                    преобразователя, %
                  </td>
                ...
                <tr class="l3-row2">
                  <td class="l3-td" rowspan="6">Принадлежности</td>
