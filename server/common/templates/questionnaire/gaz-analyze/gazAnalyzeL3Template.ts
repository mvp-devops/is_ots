  ...
  <style>
    ...
    <table id="sheet0" class="sheet0 gridlines">
      ...
      <tbody>
              ...
              <tr class="row1">
                ...
                <tr class="row1">
                  ...
                  <tr class="row1">
                    ...
                    <tr class="row2">
                        <td class="style1">Предел допускаемой основной приведенной погрешности, % НКПР</td>
                        <td class="style1" colspan="2">${accuracy}</td>
                      </tr>
                      <tr class="row2">
                          <td class="style1">Предел допускаемой вариации выходного сигнала, в долях от пределов допускаемой основной</td>
                          <td class="style1" colspan="2">${relativeAccuracy}</td>
                        </tr>
                        <tr class="row3">
                            <td class="style1">Предел допускаемой погрешности от изменения температуры окружающей среды от нормальной на каждые 10 °C, в долях от пределов допускаемой основной погрешности</td>
                            <td class="style1" colspan="2">${ambientPermissible}</td>
                          </tr>
        <tr class="row1">
        ...
        <tr class="row2">
          <td class="style1" rowspan="5">Принадлежности</td>
