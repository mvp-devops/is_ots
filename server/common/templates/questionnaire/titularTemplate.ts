  ...
  return `
            ...
            <table class="titular">
              ...
              <tbody>
                ...
                <tr class="titular-row1">
                  <td class="titular-td titular-td-style0">Заказчик:</td>
                  <td class="titular-td titular-td-style1">${subsidiary}</td>
                </tr>
                <tr class="titular-row1">
                  <td class="titular-td titular-td-style0">Месторождение:</td>
                  <td class="titular-td titular-td-style1">${field}</td>
                </tr>
                <tr class="titular-row4">
                  <td class="titular-td titular-td-style0">Объект (проект):</td>
                ...
                <tr>
                  <td colspan="2" class="titular-td">Тюмень ${year} г.</td>
                </tr>
                <tr class="titular-row">
                  <td colspan="2" class="titular-td"></td>
                </tr>
