...
export const flowL2Template = (data) => {
  const {tag, count, location, fda, parameter,
    ...
    density_1, viscosity_1, conductivity, particulateMatter,
    corrosiveImpurities, hart, hartVersion, converterType, converter,
    internalDiagnostic, outputSignal, voltage, lifeTime, mtbf, corpsMaterial, protection,
    explosionType, explosionMark, safety, connectionType, connection, pipelineDiameter,
    pipeMaterial, flowMeterDistanceBefore, flowMeterDistanceAfter, accuracy, verificationMethod,
    calibrationStamp, verification, mpi
  } = data;
...
<html>
  <head>
    ...
    <style>
      ...
      td.style10 { vertical-align:bottom; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      th.style10 { vertical-align:bottom; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      td.style11 { vertical-align:middle; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      th.style11 { vertical-align:middle; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      td.style12 { vertical-align:bottom; text-align:center; border-bottom:none #000000; border-top:1px solid #000000 !important; border-left:none #000000; border-right:none #000000; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      th.style12 { vertical-align:bottom; text-align:center; border-bottom:none #000000; border-top:1px solid #000000 !important; border-left:none #000000; border-right:none #000000; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      td.style13 { vertical-align:middle; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      th.style13 { vertical-align:middle; text-align:left; padding-left:9px; border-bottom:1px solid #000000 !important; border-top:1px solid #000000 !important; border-left:1px solid #000000 !important; border-right:1px solid #000000 !important; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      td.style14 { vertical-align:bottom; text-align:center; border-bottom:none #000000; border-top:none #000000; border-left:none #000000; border-right:none #000000; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      th.style14 { vertical-align:bottom; text-align:center; border-bottom:none #000000; border-top:none #000000; border-left:none #000000; border-right:none #000000; color:#000000; font-family:'Calibri'; font-size:11pt; background-color:white }
      ...
      table.sheet0 tr.row18 { height:33.95pt }
      table.sheet0 tr.row19 { height:33.95pt }
      table.sheet0 tr.row20 { height:51pt }
...
<!--    cellspacing="0" -->
    ...
    >
        ...
        <tbody>
          ...
          <tr class="row1">
            <td class="column0 style8 null style8" rowspan="41"></td>
          ...
          <tr class="row8">
            <td class="column1 style4 s">Диапазон измеряемых значений, м³/ч</td>
          ...
          <tr class="row9">
            ...
            <td class="column2 style10 s style10" colspan="2">${pressureMeasureAreaMin} … ${pressureMeasureAreaMax}</td>
          </tr>
          <tr class="row10">
            <td class="column1 style1 s">Температура измеряемой среды, °C</td>
            <td class="column2 style10 s style10" colspan="2">${tempMeasureAreaMin} … ${tempMeasureAreaMax}</td>
          </tr>
          <tr class="row11">
            <td class="column1 style7 s">Плотность среды при 20 ºС, кг/м³</td>
            <td class="column2 style10 s style10" colspan="2">${density_1}</td>
          </tr>
          <tr class="row12">
            <td class="column1 style6 s">Динамическая вязкость среды в р/у, сПз</td>
            <td class="column2 style13 s style13" colspan="2">${viscosity_1}</td>
          </tr>
          <tr class="row13">
            <td class="column1 style2 s">Электропроводность среды</td>
            <td class="column2 style10 s style10" colspan="2">${conductivity}</td>
          </tr>
          <tr class="row14">
            <td class="column1 style2 s">Присутствие твердых частиц</td>
            <td class="column2 style10 s style10" colspan="2">${particulateMatter ? "Да" : "Нет"}</td>
          </tr>
          <tr class="row15">
            <td class="column1 style2 s">Коррозионные примеси, %</td>
            <td class="column2 style10 s style10" colspan="2">${corrosiveImpurities}</td>
          </tr>
          <tr class="row16">
            <td class="column1 style9 s style9" rowspan="4">Преобразователь</td>
          ...
          <tr class="row18">
            <td class="column2 style3 s">Тип вторичного преобразователя</td>
            <td class="column3 style3 s">${converterType}</td>
          </tr>
          <tr class="row19">
            <td class="column2 style3 s">Монтаж вторичного преобразователя</td>
            <td class="column3 style3 s">${converter}</td>
          </tr>
          <tr class="row20">
            <td class="column1 style2 s">Возможность проверки электроники расходомера средствами самодиагностики без подключения дополнительного оборудования</td>
            <td class="column2 style11 s style11" colspan="2">${internalDiagnostic ? "Да" : "Нет"}</td>
          </tr>
          <tr class="row21">
          ...
          <tr class="row30">
            ...
            <td class="column2 style10 s style10" colspan="2">${connectionType}</td>
          </tr>
          <tr class="row31">
            <td class="column1 style1 s">Соединение с тех. процессом</td>
            <td class="column2 style10 s style10" colspan="2">${connection}</td>
          </tr>
          <tr class="row32">
            <td class="column1 style1 s">Диаметр трубопровода Ду, мм</td>
            <td class="column2 style10 s style10" colspan="2">${pipelineDiameter}</td>
          </tr>
          <tr class="row33">
            <td class="column1 style1 s">Материал трубопровода</td>
            <td class="column2 style10 s style10" colspan="2">${pipeMaterial}</td>
          </tr>
          <tr class="row34">
            <td class="column1 style2 s">Расстояние участка до расходомера</td>
            <td class="column2 style10 s style10" colspan="2">${flowMeterDistanceBefore}</td>
          </tr>
          <tr class="row35">
            <td class="column1 style1 s">Расстояние участка после расходомера</td>
            <td class="column2 style10 s style10" colspan="2">${flowMeterDistanceAfter}</td>
          </tr>
          <tr class="row36">
            <td class="column1 style2 s">Предел допускаемой основной приведенной погрешности, %</td>
            <td class="column2 style11 s style11" colspan="2">${accuracy}</td>
          </tr>
          <tr class="row37">
            <td class="column1 style2 s">Метод поверки</td>
            <td class="column2 style10 s style10" colspan="2">${verificationMethod}</td>
          </tr>
          <tr class="row38">
          ...
          <tr class="row41">
            <td class="column1 style12 null style12" colspan="3"></td>
          </tr>
        </tbody>
    </table>
  </body>
