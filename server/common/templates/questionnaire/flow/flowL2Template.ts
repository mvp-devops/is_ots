export const flowL2Template = (data: any) => {
  const {
    ...
    connection, pipelineDiameter, pipeMaterial, flowMeterDistanceBefore, flowMeterDistanceAfter} = data;

  return `
<style>
  table {border-collapse: collapse; page-break-after: always;}
  col.col0 {width: 300pt;}
  col.col1 {width: 120pt;}
  col.col2 {width: 200pt;}
  ...
  tr.row4 {height: 68pt;}
  tr.row5 {height: 85pt;}
  td {vertical-align: middle; text-align: left; padding-left: 5px; text-align: center; color: #000000; font-family: "Arial"; font-size: 10pt; background-color: white;}
  td.style0 {border-bottom: 1px solid #000000 !important;}
  td.style1 {border: 1px solid #000000 !important;}
</style>
<table class="sheetl2">
  <col class="col0" />
  <col class="col1" />
  ...
  <tbody>
    ...
    <tr class="row1">
      <td class="style1">Температура измеряемой среды, °C</td>
      <td class="style1" colspan="2">
        ${tempMeasureAreaMin} … ${tempMeasureAreaMax}
      </td>
    </tr>
    <tr class="row1">
      <td class="style1">Плотность среды при 20 ºС, кг/м³</td>
      <td class="style1" colspan="2">${density_1}</td>
    </tr>
    <tr class="row1">
      <td class="style1">
        Динамическая вязкость среды в р/у, сПз
      </td>
      <td class="style1" colspan="2">${viscosity_1}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Электропроводность среды</td>
      <td class="style1" colspan="2">${conductivity}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Присутствие твердых частиц</td>
      <td class="style1" colspan="2">${particulateMatter ? "Да" : "Нет"}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Коррозионные примеси, %</td>
      <td class="style1" colspan="2">
        ${corrosiveImpurities}
      </td>
    </tr>
    ...
    <tr class="row2">
      ...
      <td class="style1" style="width: 300px;">${converterType}</td>
    </tr>
    <tr class="row2">
    ...
    <tr class="row3">
      <td class="style1">
        Возможность проверки электроники расходомера средствами самодиагностики
        без подключения дополнительного оборудования
      </td>
      <td class="style1" colspan="2">
    ...
    <tr class="row1">
      <td class="style1">Диаметр трубопровода Ду, мм</td>
      <td class="style1" colspan="2">${pipelineDiameter}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Материал трубопровода</td>
      <td class="style1" colspan="2">${pipeMaterial}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Расстояние участка до расходомера, мм</td>
      <td class="style1" colspan="2">${flowMeterDistanceBefore}</td>
    </tr>
    <tr class="row1">
      <td class="style1">Расстояние участка после расходомера, мм</td>
      <td class="style1" colspan="2">${flowMeterDistanceAfter}</td>
    </tr>
  </tbody>
</table>
  `
